...
namespace Регулярка_От_Жигулина__29._03._2021_
{
    class Program
    {
        ...
        // Метод распаковки.
        // Принцип действия: Он ищет внешние скобки, когда найдет он ищет число перед скобками,
        //                   потом вызывает себя, но уже с подстрокой и числом (число нужно чтобы умножить строку),
        //                   которая была внутри скобок. Потом получает готовую подстроку и вставляет ее на место (число и скобки удаляет).
        // text - это входное слово, multiply - число, которое умножает строку.
